...
void Initialize_Hamon(NFcontext_p context) {
    ...
    static struct NFvariable_s variables[] = {{"airtemp", NFinput,  "degC",   NFscalar(HamonData_t,
                                                                                       Airtemp),       NFmissingVal},
                                              {"vpress",  NFinput,  "kPa",    NFscalar(HamonData_t,
                                                                                       VaporPressure), NFmissingVal},
                                              {"Vector",  NFoutput, "m",      NFvector(HamonData_t,
                                                                                       Vector),        NFmissingVal},
                                              {"pet",     NFoutput, "mm/day", NFscalar(HamonData_t,
                                                                                       PotEvap),       NFmissingVal}};
...
void Initialize_PsTaylor(NFcontext_p context) {
    ...
    static struct NFvariable_s variables[] = {{"airtemp", NFinput,  "degC",   NFscalar(PsTaylorData_t,
                                                                                       AirTemp), NFmissingVal},
                                              {"vpress",  NFinput,  "kPa",    NFscalar(PsTaylorData_t,
                                                                                       VaporP),  NFmissingVal},
                                              {"solrad",  NFinput,  "MJ/m2",  NFscalar(PsTaylorData_t,
                                                                                       SolRad),  NFmissingVal},
                                              {"pet",     NFoutput, "mm/day", NFscalar(PsTaylorData_t,
                                                                                       Pet),     NFmissingVal}};
    context->TimeStepUnit = "day";
    context->MinTimeStep = context->MaxTimeStep = 1;
    context->ParameterNum = NFparameterNum (parameters);
