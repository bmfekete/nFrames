...
typedef enum {
    NCaxisX, NCaxisY, NCaxisZ, NCaxisTime
} NCaxisType;
typedef enum {
    NCprojGeographic, NCprojRotatedPole, NCprojCartesian
} NCprojType;
...
typedef enum {
    NCdirUp = true, NCdirDown = false, NCdirLeft = true, NDdirRight = false
} NCdirection;
...
typedef enum {
    NCurlInvalid, NCurlFile, NCurlHttp, NCurlFtp
} NCurlType;
