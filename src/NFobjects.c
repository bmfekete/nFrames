...
const char *NFobjTypeName(NFobjType objType) {
    ...
    switch (objType) {
        case NFcompAggregate:
            return (NFcompAggregateStr);
        case NFcompContainer:
            return (NFcompContainerStr);
        case NFcompInput:
            return (NFcompInputStr);
        case NFcompModel:
            return (NFcompModelStr);
        case NFcompRegion:
            return (NFcompRegionStr);
        case NFmodDerivative:
            return (NFmodDerivativeStr);
        case NFmodEquation:
            return (NFmodEquationStr);
        case NFmodInterface:
            return (NFmodInterfaceStr);
        case NFmodProcess:
            return (NFmodProcessStr);
        case NFmodRoute:
            return (NFmodRouteStr);
        case NFnumInitial:
            return (NFnumInitialStr);
        case NFnumParameter:
            return (NFnumParameterStr);
        case NFnumVariable:
            return (NFnumVariableStr);
        case NFobjAlias:
            return (NFobjAliasStr);
        case NFobjCategory:
            return (NFobjCategoryStr);
        case NFobjOutput:
            return (NFobjOutputStr);
        case NFobjPlugin:
            return (NFobjPluginStr);
    }
    return ((char *) NULL);
}
...
static int _NFobjectSize(NFobjType objType) {
    ...
    switch (objType) {
        case NFcompAggregate:
            return (sizeof(NFcompAggregate_t));
        case NFcompContainer:
            return (sizeof(NFcompContainer_t));
        case NFcompInput:
            return (sizeof(NFcompInput_t));
        case NFcompModel:
            return (sizeof(NFcompModel_t));
        case NFcompRegion:
            return (sizeof(NFcompRegion_t));
        case NFmodDerivative:
            return (sizeof(NFmodDerivative_t));
        case NFmodEquation:
            return (sizeof(NFmodEquation_t));
        case NFmodInterface:
            return (sizeof(NFmodInterface_t));
        case NFmodProcess:
            return (sizeof(NFmodProcess_t));
        case NFmodRoute:
            return (sizeof(NFmodRoute_t));
        case NFnumInitial:
            return (sizeof(NFnumVariable_t));
        case NFnumParameter:
            return (sizeof(NFnumParameter_t));
        case NFnumVariable:
            return (sizeof(NFnumVariable_t));
        case NFobjAlias:
            return (sizeof(NFobjAlias_t));
        case NFobjCategory:
            return (sizeof(NFobjCategory_t));
        case NFobjOutput:
            return (sizeof(NFobjOutput_t));
        case NFobjPlugin:
            return (sizeof(NFobjPlugin_t));
    }
    return (CMfailed);
}
...
void NFobjectFree(NFobject_p object) {
    ...
    switch (object->Type) {
        case NFcompAggregate:
            _NFcompAggregateFree(object);
            break;
        case NFcompContainer:
            _NFcompContainerFree(object);
            break;
        case NFcompInput:
            _NFcompInputFree(object);
            break;
        case NFcompModel:
            _NFcompModelFree(object);
            break;
        case NFcompRegion:
            _NFcompRegionFree(object);
            break;
        case NFmodDerivative:
            _NFmodDerivativeFree(object);
            break;
        case NFmodEquation:
            _NFmodEquationFree(object);
            break;
        case NFmodInterface:
            _NFmodInterfaceFree(object);
            break;
        case NFmodProcess:
            _NFmodProcessFree(object);
            break;
        case NFmodRoute:
            _NFmodRouteFree(object);
            break;
        case NFnumInitial:
            _NFnumVariableFree(object);
            break;
        case NFnumParameter:
            _NFnumParameterFree(object);
            break;
        case NFnumVariable:
            _NFnumVariableFree(object);
            break;
        case NFobjAlias:
            _NFobjAliasFree(object);
            break;
        case NFobjCategory:
            _NFobjCategoryFree(object);
            break;
        case NFobjOutput:
            _NFobjOutputFree(object);
            break;
        case NFobjPlugin:
            _NFobjPluginFree(object);
            break;
    }
