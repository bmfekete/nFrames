...
static void XMLCALL _NFentryStart(void *argPtr, const char *entry, const char **attr) {
    const char *name;
    const char *modelChildren[] = {NFcompAggregateStr, NFcompContainerStr, NFcompInputStr, NFcompRegionStr,
                                   NFnumParameterStr, (char *) NULL};
    ...
    if (data->Stack == 0) { // Document root level
            ...
            case NFcompAggregate:
                if (CMoptLookup(aggregateChildren, entry, true) == CMfailed) {
                    CMmsgPrint(CMmsgWarning, "Skipping [%s] section [%s] in %s [%s]\n", entry, name,
                               NFobjTypeName(parent->Type), parent->Name);
                    goto Skip;
                }
                break;
        ...
        if (strcmp(entry, NFdimensionStr) == 0) {
            ...
            switch (NFobjTypeCode(entry)) {
                case NFcompAggregate:
                    object = NFparseCompAggregateCreate(parser, parent, name, attr);
                    break;
                case NFcompContainer:
                    object = NFparseCompContainerCreate(parser, parent, name, attr);
                    break;
                case NFcompInput:
                    object = NFparseCompInputCreate(parser, parent, name, attr);
                    break;
                case NFcompModel:
                    CMmsgPrint(CMmsgAppError, "This should never happen! %s:%d\n", __FILE__, __LINE__);
                    goto Skip;
                case NFcompRegion:
                    object = NFparseCompRegionCreate(parser, parent, name, attr);
                    break;
                case NFnumInitial:
                    object = NFparseNumVariableCreate(parser, parent, name, attr);
                    break;
                case NFnumParameter:
                    object = NFparseNumParameterCreate(parser, parent, name, attr);
                    break;
                case NFnumVariable:
                    object = NFparseNumVariableCreate(parser, parent, name, attr);
                    break;
                case NFmodDerivative:
                    object = NFparseModDerivativeCreate(parser, parent, name, attr);
                    break;
                case NFmodEquation:
                    object = NFparseModEquationCreate(parser, parent, name, attr);
                    break;
                case NFmodInterface:
                    object = NFparseModInterfaceCreate(parser, parent, name, attr);
                    break;
                case NFmodProcess:
                    object = NFparseModProcessCreate(parser, parent, name, attr);
                    break;
                case NFmodRoute:
                    object = NFparseModRouteCreate(parser, parent, name, attr);
                    break;
                case NFobjAlias:
                    object = NFparseObjAliasCreate(parser, parent, name, attr);
                    break;
                case NFobjCategory:
                    object = NFparseObjCategoryCreate(parser, parent, name, attr);
                    break;
                case NFobjOutput:
                    object = NFparseObjOutputCreate(parser, parent, name, attr);
                    break;
                case NFobjPlugin:
                    CMmsgPrint(CMmsgAppError, "This should never happen! %s:%d\n", __FILE__, __LINE__);
                    goto Skip;
...
static void XMLCALL _NFentryEnd(void *argPtr, const char *entry) {
    ...
    switch (object->Type) {
        case NFcompAggregate:
            ret = NFparseCompAggregateFinalize(parent, object);
            break;
        case NFcompContainer:
            ret = NFparseCompContainerFinalize(parent, object);
            break;
        case NFcompInput:
            ret = NFparseCompInputFinalize(parent, object);
            break;
        case NFcompModel:
            ret = NFparseCompModelFinalize(object);
            break;
        case NFcompRegion:
            ret = NFparseCompRegionFinalize(parent, object);
            break;
        case NFnumInitial:
            ret = NFparseNumVariableFinalize(parent, object);
            break;
        case NFnumParameter:
            ret = NFparseNumParameterFinalize(parent, object);
            break;
        case NFnumVariable:
            ret = NFparseNumVariableFinalize(parent, object);
            break;
        case NFmodDerivative:
            ret = NFparseModDerivativeFinalize(parent, object);
            break;
        case NFmodInterface:
            ret = NFparseModInterfaceFinalize(parent, object);
            break;
        case NFmodEquation:
            ret = NFparseModEquationFinalize(parent, object);
            break;
        case NFmodProcess:
            ret = NFparseModProcessFinalize(parent, object);
            break;
        case NFmodRoute:
            ret = NFparseModRouteFinalize(parent, object);
            break;
        case NFobjAlias:
            ret = NFparseObjAliasFinalize(parent, object);
            break;
        case NFobjCategory:
            ret = NFparseObjCategoryFinalize(parent, object);
            break;
        case NFobjOutput:
            ret = NFparseObjOutputFinalize(parent, object);
            break;
        case NFobjPlugin:
            CMmsgPrint(CMmsgAppError, "This should never happen! %s:%d\n", __FILE__, __LINE__);
            break;
